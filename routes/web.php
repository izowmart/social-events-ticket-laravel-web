...
Route::group(['middleware' => 'admin_auth', 'prefix' => 'admin'], function () {
    ...
    Route::group(['prefix'=>'venues'], function () {
        ...
        Route::get('active_venues', 'AdminPages\HomeController@active_venues_chart')->name('active_venues_chart');
    });
...
Route::group(['middleware' => 'event_organizer_auth','prefix'=>'event_organizer'], function () {
    ...
    Route::group(['prefix'=>'events'], function () {
        ...
        Route::post('edit', 'CommonPages\EventsController@showEditForm')->name('edit_event');   
        Route::post('edit/update', 'CommonPages\EventsController@update')->name('edit_event_post');   
